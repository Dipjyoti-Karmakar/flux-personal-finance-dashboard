...
Flux is a **14,000+ line single-file web application**, with all HTML, CSS, and JavaScript in one `index.html` file. It uses **Firebase Auth v11.6.1** (Google sign-in popup) and **Cloud Firestore** with persistent local cache for real-time sync across devices and full offline support.
